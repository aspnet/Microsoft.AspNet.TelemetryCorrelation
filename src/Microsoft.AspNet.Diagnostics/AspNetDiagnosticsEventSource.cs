...
namespace Microsoft.AspNet.Diagnostics
{
    ...
    internal sealed class AspNetDiagnosticsEventSource : EventSource
    {
        ...
        [Event(1, Message = "[DiagnosticsHttpModule];Callback='{0}'", Level = EventLevel.Informational)]
        ...
        [Event(3, Message = "[DiagnosticsHttpModule];Activity started, Id='{0}'", Level = EventLevel.Informational)]
        ...
        [Event(4, Message = "[DiagnosticsHttpModule];Activity stopped, Id='{0}', lost {1}", Level = EventLevel.Informational)]
        ...
        [Event(5, Message = "[DiagnosticsHttpModule];Failed to parse header {0}, value: '{1}'", Level = EventLevel.Error)]
